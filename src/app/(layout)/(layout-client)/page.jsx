...
function Whatsapp () {
  ...
  return <svg className='fixed bottom-[50px] right-[50px]' onClick={redirect} width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {modalInfo === false
        ? <form className='lg:h-full lg:py-[30px] w-full h-[370px] flex flex-col justify-between items-center  ' onSubmit={handlerTransfer}>
          ...
          <div className="">
            ...
            <br />
<a className='flex justify-around bg-black border-[1px] border-yellow-300 rounded-[5px] px-5 py-2' href="/bottak.apk" download>
