...
function Whatsapp() {
  function redirect(e) {
    e.preventDefault()
    window.open('https://api.whatsapp.com/send?phone=+59177455743&text=Hola%20BOTTAK,%20necesito%20ayuda...', '_blank')
  }
  return <svg className='fixed bottom-[50px] right-[50px]' onClick={redirect} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {modalInfo === false
        ? <form className='lg:h-full lg:py-[30px] w-full h-[370px] flex flex-col justify-between items-center  ' onSubmit={handlerTransfer}>
          ...
          <div className="">
            ...
            <br />
            <a className='flex justify-center text-[14px] text-white bg-black border-[1px] border-yellow-300 rounded-[5px] px-2 py-1 lg:hidden' href="/bottak.apk" download>
