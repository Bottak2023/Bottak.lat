...
console.log(filterQR)
    ...
    return (<div>
        ...
        <label htmlFor="qr" className='w-[90vw] relative mb-3 left-0 right-0 m-auto  max-w-[600px] lg:min-w-[600px] border-[5px] border-[#000000] flex justify-between items-center text-gray-950 text-[16px] h-[50px] bg-[#FFF500] rounded-full py-[5px] px-[10px] lg:px-[20px] z-20' >
            <span className=''>
            ...
            <span className=' left-0 top-0 bottom-0 my-auto text-center text-[16px] font-bold'> Tracking por QR...</span>
            <span className=''>
