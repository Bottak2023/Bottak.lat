...
export default function Button({ styled, children }) {
    return (
        <label
            className=" bg-[#FFF500]  hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px] p-2                                                                                                                      w-[100%] max-w-[350px] px-5 py-3 text-center"
