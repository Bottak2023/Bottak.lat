    ...
    switch (theme) {
        ...
        case 'Success':
            return <button
                ...
                className="text-white bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px] w-full min-w-[180px]  sm:max-w-[380px] px-5 py-3 text-center"
