    ...
    switch (theme) {
        ...
        case 'Success':
            return <button
                ...
                className="text-white bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px] w-full sm:max-w-[350px] px-5 py-3 text-center"
            ...
            case 'Disable':
                return <button
                    type="submit"
                    className={`bg-transparent text-gray-400 border-[1px] border-gray-400 font-medium rounded-full text-[14px]  w-[100%] sm:max-w-[380px] px-5 py-3 text-center`} 
                    // className="text-white bg-violet-700 hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[14px] w-full sm:w-auto px-5 py-3.5 text-center 
                    // dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    onClick={click}
                >
