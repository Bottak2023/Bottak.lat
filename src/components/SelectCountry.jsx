...
// import countriesJSON from '@/utils/countries'

export default function App({ placeholder, value, onChange, propHandlerSelect, propSelect, propIsSelect, propHandlerIsSelect }) {
    const { userDB,  setUserSuccess, select, setSelect, select2, setSelect2, transferencia, setTransferencia, success, setuserSuccess, countries, setCountries, isSelect, setIsSelect, isSelect2, setIsSelect2, } = useUser()

    function handlerUserSelect(e, i) {
        console.log('child')
        propHandlerSelect(i.cca3)
    }
