...
export default function App({ propIsSelect, propHandlerIsSelect, operation, click }) {
    ...
    return (
        <div className={`relative w-full sm:max-w-[380px] bg-transparent border border-gray-300 text-gray-900 text-[14px] rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-0 `} >
            ...
            {propIsSelect === false && operation === 'recepcion' && countrie && countrie !== undefined && countrie.translation.spa.common === select && countrie['envio'] !== true && <span className=" text-green-400 text-[14px] font-light">{countrie.translation.spa.common} esta habilitado unicamente para recepciones de dinero</span>}
