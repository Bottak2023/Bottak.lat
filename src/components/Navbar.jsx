                    ...
                    <div className="absolute top-0 w-screen  flex flex-wrap items-center justify-between mx-auto p-[10px] z-50" style={{
                        ...
                        <div className=' flex items-center'>
                            ...
                            {user !== null && user !== undefined && userDB !== null && userDB !== undefined
                                ...
                                ? <button type="button" className="inline-flex h-[20px] justify-center items-center bg-[#FFF500] text-[12px] text-center font-medium  align-middle px-3 py-3 rounded-full hover:bg-gray-100 sm:hover:bg-transparent  border-[2px] border-[#FFF500] hover:text-yellow-300 sm:hidden" onClick={handleSignOut}>
                                    Cerrar Sesion
                                </button>
                                : <button type="button" className="inline-flex h-[20px] justify-center items-center bg-[#FFF500] text-[12px] text-center font-medium  align-middle px-3 py-3 rounded-full hover:bg-gray-100 sm:hover:bg-transparent  border-[2px] border-[#FFF500] hover:text-yellow-300 sm:hidden" onClick={()=>router.push('/Login')}>
                                    Iniciar Sesión
                                </button>
                            }
            ...
            <ul className={`fixed  top-0 pt-[60px] w-[100vw]  sm:max-w-[400px] transition-all  z-20 px-[30px]  sm:flex  sm:items-center sm:justify-between sm:h-[70px] sm:min-h-auto sm:pt-[10px] sm:z-50  ${nav ? 'left-0 ' : 'left-[-100vw] sm:left-auto sm:right-[10px]'}`} >
                ...
                {userDB && userDB.rol && (userDB.rol === 'Admin' || userDB.rol === 'Cliente') && <li onClick={() => handlerNavItem('Mi cuenta')}>
                    ...
                    <div className={`relative sm:absolute sm:top-[80px] sm:right-[20px]  sm:w-[300px]  sm:bg-black  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  ${navItem === 'Mi cuenta' ? 'h-auto sm:p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        {/* {userDB && userDB.rol && userDB.rol === 'Admin' &&
                            <Link href="/Admin" className="flex flex-col justify-between items-center bg-[#FFF500] text-[12px] text-center font-medium   px-3 py-3 rounded-[15px]  sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                                <Profile />
                                Admin
                            </Link>
                        } */}
                        {userDB && userDB.rol && (userDB.rol === 'Cliente' || userDB.rol === 'Admin') && <>
                            {userDB && userDB.rol && userDB.rol !== undefined && <Link href="/Admin" className="flex flex-col justify-between items-center bg-[#FFF500] text-[12px] text-center font-medium   px-3 py-3 rounded-[15px]  sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                                <Profile />
                                Admin
                            </Link>}
                ...
                <li onClick={() => handlerNavItem('Acerca')}>
                    ...
                    {user !== null && user !== undefined && userDB !== null && userDB !== undefined
                        ...
                        // <Link href="/Login" className="h-[40px] flex justify-center items-center bg-[#FFF500] text-[12px] text-center font-medium  align-middle px-3 py-3 rounded-full hover:bg-gray-100 sm:hover:bg-transparent sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                        //     Iniciar Sesión
                        // </Link>
                    }
...
//         <li>
//             <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500] text-[12px] text-center font-medium   px-3 py-3 rounded-[15px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>Mis Transacciones</Link>
//         </li>}
//     <li>
