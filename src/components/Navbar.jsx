...
export default function Navbar({ children }) {
    ...
    return (
            <div className={`absolute min-h-screen bg-gray-900 top-0 items-center justify-between  w-[250px]  md:flex md:w-auto  transition-all	z-50 ${nav ? 'left-0' : 'left-[-100vw]'}`} >
                <ul className="flex flex-col bg-transparent p-4 md:p-0 mt-4 lg:font-normal lg:text-[12px]  md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
                    <li>
