...
export default function Navbar({ children }) {
    ...
    return (
        <>
            ...
            <ul className={`fixed h-[100vh] overflow-y-scroll sm:overflow-auto top-0 pt-[60px] w-[100vw]  sm:max-w-[500px] z-20 px-[30px]  sm:flex  sm:items-center sm:justify-between sm:h-[70px] sm:min-h-auto sm:pt-[10px] sm:z-50  ${nav ? 'left-0 ' : 'left-[-100vw] sm:left-auto sm:right-[70px]'}`} style={{ transition: 'all .02s linear' }} onClick={(e) => e.stopPropagation()} >
