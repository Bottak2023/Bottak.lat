...
function Profile() {
    return <span className='inline-block px-5 py-5 rounded-full bg-[black]'>
        ...
        <>
                    ...
                    <div className="absolute top-0 w-screen  flex flex-wrap items-center justify-between mx-auto p-[10px] z-50" style={{
                        ...
                        <div className=' flex items-center'>
                            ...
                            {user !== null && user !== undefined && userDB !== null && userDB !== undefined
                                ...
                                ? <button type="button" className="inline-flex h-[20px] justify-center items-center bg-[#FFF500] text-center font-medium  align-middle px-5 py-5 rounded-full hover:bg-gray-100 sm:hover:bg-transparent  border-[2px] border-[#FFF500] hover:text-yellow-300 sm:hidden" onClick={handleSignOut}>
                                    Cerrar Sesion
                                </button>
                                : <button type="button" className="inline-flex h-[20px] justify-center items-center bg-[#FFF500] text-center font-medium  align-middle px-5 py-5 rounded-full hover:bg-gray-100 sm:hover:bg-transparent  border-[2px] border-[#FFF500] hover:text-yellow-300 sm:hidden" onClick={()=>router.push('/Login')}>
                                    Iniciar Sesión
                                </button>
                            }
            ...
            <ul className={`fixed  top-0 pt-[60px] w-[100vw]  sm:max-w-[400px] transition-all  z-20 px-[30px]  sm:flex  sm:items-center sm:justify-between sm:h-[70px] sm:min-h-auto sm:pt-[10px] sm:z-50  ${nav ? 'left-0 ' : 'left-[-100vw] sm:left-auto sm:right-[10px]'}`} >
                ...
                {userDB && userDB.rol && (userDB.rol === 'Admin' || userDB.rol === 'Cliente') && <li onClick={() => handlerNavItem('Mi cuenta')}>
                    ...
                    <div className={`relative sm:absolute sm:top-[80px] sm:right-[20px]  sm:w-[350px]  sm:bg-black  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  ${navItem === 'Mi cuenta' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        {/* {userDB && userDB.rol && userDB.rol === 'Admin' &&
                            <Link href="/Admin" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]  sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                                <Profile />
                                Admin
                            </Link>
                        } */}
                        {userDB && userDB.rol && (userDB.rol === 'Cliente' || userDB.rol === 'Admin') && <>
                            {userDB && userDB.rol && userDB.rol !== undefined && <Link href="/Admin" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]  sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                                <Profile />
                                Admin
                            </Link>}
                            <Link href="/Transacciones" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                                <Historial />
                                Mis Transacciones
                            </Link>
                            {user !== null && user !== undefined
                                ? <button className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px] hover:bg-gray-100 sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={signOutHandler}>
                                    <Logout />
                                    Cerrar sesión
                                </button>
                                : <Link href="/Login" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px] hover:bg-gray-100 sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                                    <Logout />
                                    Iniciar Sesión
                                </Link>
                            }
                ...
                <li onClick={() => handlerNavItem('Servicios')}>
                    <h3 className='text-[14px] font-bold sm:text-[12px] sm:font-normal text-white py-5 cursor-pointer'>SERVICIOS</h3>
                    <div className={`relative sm:absolute sm:top-[80px] sm:right-[20px]  sm:w-[350px]  sm:bg-black  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  ${navItem === 'Servicios' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        <Link href="/" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px] sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Remesas />
                            Remesas
                        </Link>
                        <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Cambios />
                            Cambios
                        </Link>
                        <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                        ...
                        <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                            <Tracking />
                            Tracking
                        </Link>
                    </div>
                ...
                <li onClick={() => handlerNavItem('Acerca')}>
                    <h3 className='text-[14px] font-bold sm:text-[12px] sm:font-normal text-white py-5 cursor-pointer'>ACERCA DE</h3>
                    <div className={`relative sm:absolute sm:top-[80px] sm:right-[20px]  sm:w-[350px]  sm:bg-black  grid grid-cols-2 gap-[20px]  rounded-2xl z-20   ${navItem === 'Acerca' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        ...
                        <Link href="#" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px] hover:bg-gray-100 sm:hover:bg-transparent sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Politicas />
                            Politicas
                        </Link>
                    </div>
                    ...
                    {user !== null && user !== undefined && userDB !== null && userDB !== undefined
                        ...
                        // <Link href="/Login" className="h-[40px] flex justify-center items-center bg-[#FFF500] text-center font-medium  align-middle px-5 py-5 rounded-full hover:bg-gray-100 sm:hover:bg-transparent sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                        //     Iniciar Sesión
                        // </Link>
                    }
...
// <div className={`relative sm:absolute h-[125px] top-0 pt-[70px]  grid grid-cols-3 gapx-5 py-5  w-[100vw]   transition-all	z-20 px-[10px]  ${userNav ? 'top-0 ' : 'top-[-100vw]'}`} >
...
//     <li>
//         <Link href="/" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px] sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>Remesas</Link>
//     </li>
//     <li>
//         <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>Cambios</Link>
//     </li>
//     {userDB && userDB.rol && userDB.rol === 'Cliente' &&
//         <li>
//             <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300 " onClick={() => setNav(false)}>Mis Transacciones</Link>
//         </li>}
//     <li>
//         <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500] text-center font-medium   px-5 py-5 rounded-[25px]   sm:hover:bg-transparent border-[2px] border-[#FFF500] sm:hover:text-yellow-300" onClick={() => setNav(false)}>Tracking</Link>
//     </li>
// </ul>
// </div> 