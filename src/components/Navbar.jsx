...
function Historial() {
    return <span className='inline-block p-5 rounded-[30px]-full bg-[black]'>
        ...
        <>
            ...
            <ul className={`absolute top-0 pt-[60px]  w-[100vw]  sm:max-w-[350px] transition-all	z-20 px-[30px]  sm:flex  sm:items-center sm:justify-between sm:h-auto sm:min-h-auto sm:pt-[10px] sm:z-50  ${nav ? 'left-0 ' : 'left-[-100vw] sm:left-auto sm:right-[10px]'}`} >
                ...
                {userDB && userDB.rol && (userDB.rol === 'Admin' || userDB.rol === 'Cliente') && <li onClick={() => handlerNavItem('Mi cuenta')}>
                    ...
                    <div className={`relative sm:absolute sm:top-[90px] sm:right-[20px] sm:w-[350px]  sm:bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-[30px]-2xl z-20  ${navItem === 'Mi cuenta' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        {userDB && userDB.rol && userDB.rol === 'Admin' &&
                            <Link href="/Admin" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]   sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                                Admin
                            </Link>
                        }
                        {userDB && userDB.rol && userDB.rol === 'Cliente' && <>
                            <Link href="/Cliente" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]   sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                                Perfil
                            </Link>
                            <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300 " onClick={() => setNav(false)}>
                                <Historial />
                                Mis Transacciones
                            </Link>
                            {user !== null && user !== undefined
                                ? <button className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px] hover:bg-gray-100 sm:hover:bg-transparent sm:hover:text-yellow-300" onClick={signOutHandler}>
                                    <Logout />
                                    Cerrar sesión
                                </button>
                                : <Link href="/Login" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px] hover:bg-gray-100 sm:hover:bg-transparent sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                                    <Logout />
                                    Iniciar Sesión
                                </Link>
                            }
                ...
                <li onClick={() => handlerNavItem('Servicios')}>
                    ...
                    <div className={`relative sm:absolute sm:top-[90px] sm:right-[20px] sm:w-[350px]  sm:bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-[30px]-2xl z-20  ${navItem === 'Servicios' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        <Link href="/" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]  sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Remesas />
                            Remesas
                        </Link>
                        <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Cambios />
                            Cambios
                        </Link>
                        <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                        ...
                        <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300 lg:hidden" onClick={() => setNav(false)}>
                            <Tracking />
                            Tracking
                        </Link>
                    </div>
                ...
                <li onClick={() => handlerNavItem('Acerca')}>
                    ...
                    <div className={`relative sm:absolute sm:top-[90px] sm:right-[20px] sm:w-[350px]  sm:bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-[30px]-2xl z-20   ${navItem === 'Acerca' ? 'h-auto p-[20px]' : 'h-auto sm:h-0 sm:overflow-hidden'}`}>
                        <Link href="#" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Nosotros />
                            Nosotros
                        </Link>
                        <Link href="#" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px] hover:bg-gray-100 sm:hover:bg-transparent sm:hover:text-yellow-300" onClick={() => setNav(false)}>
                            <Politicas />
                            Politicas
                        </Link>
                    </div>
...
//     <li>
//         <Link href="/" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]  sm:hover:text-yellow-300" onClick={() => setNav(false)}>Remesas</Link>
//     </li>
//     <li>
//         <Link href="/Cambios" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300" onClick={() => setNav(false)}>Cambios</Link>
//     </li>
//     {userDB && userDB.rol && userDB.rol === 'Cliente' &&
//         <li>
//             <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300 " onClick={() => setNav(false)}>Mis Transacciones</Link>
//         </li>}
//     <li>
//         <Link href="/Tracking" className="flex flex-col justify-between items-center bg-[#FFF500]   py-2 pl-3 pr-4  rounded-[30px]    sm:hover:text-yellow-300" onClick={() => setNav(false)}>Tracking</Link>
//     </li>
// </ul>
// </div> 